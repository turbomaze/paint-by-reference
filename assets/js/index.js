class PaintByReference {
  static init() {
    ...
    const paintByReference = new PaintByReference(1920, 1080, 15, camera, render);
  ...
  start() {
    ...
    PaintByReference.registerVideoHandlers(
      this.width,
      this.height,
      s => {
...
window.addEventListener('DOMContentLoaded', PaintByReference.init);
